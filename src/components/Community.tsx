    ...
    >
      <div className="container mx-auto px-4 max-w-[1100px]">
        ...
        <div className="flex justify-center space-x-8">
          <a 
            href="https://discord.gg/uavJ34JTWY" 
            target="_blank" 
            rel="noopener noreferrer"
            className="social-icon"
          >
            <div className="w-16 h-16 bg-discord bg-contain bg-no-repeat bg-center hover:opacity-80 transition-opacity rounded-full p-2 ring-1 ring-white/20" style={{ backgroundColor: '#5865F2' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="white" className="w-full h-full">
          ...
          <a 
            href="https://github.com/ra2web" 
            target="_blank" 
            rel="noopener noreferrer"
            className="social-icon"
          >
            <div className="w-16 h-16 bg-github bg-contain bg-no-repeat bg-center hover:opacity-80 transition-opacity rounded-full p-3 ring-1 ring-white/20" style={{ backgroundColor: '#333' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="white" className="w-full h-full">
